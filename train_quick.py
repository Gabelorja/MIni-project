"""
Quick training script with fewer epochs for faster results
"""
import torch
...
def main():
    ...
    # Save model
    torch.save(model.state_dict(), 'xo_model_quick.pth')
    print("\n✅ Model saved as 'xo_model_quick.pth'")
